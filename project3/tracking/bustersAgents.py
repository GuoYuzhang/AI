...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        nearestPos = mostLikelyPositions[0]
        nearestDis = self.distancer.getDistance(pacmanPosition, nearestPos)
        for p in mostLikelyPositions[1:]:
        ...
        for action in legal:
            ...
            if self.distancer.getDistance(newPos, nearestPos) < nearestDis:
                a = action
                break
